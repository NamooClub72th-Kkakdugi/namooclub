		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="well">
					...
					<form class="form-horizontal" action="./user/joinCheck.do" method="post">
						<fieldset>
							<div class="form-group">
								<label class="col-lg-2 control-label">이름</label>

								<div class="col-lg-10">
									<input type="text" class="form-control" placeholder="이름" readonly="readonly" value="${name}">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" placeholder="이메일" readonly="readonly" value="${email}">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="password" class="form-control" placeholder="비밀번호" readonly="readonly" value="${password}">
								</div>
							</div>
							<div class="form-group">
