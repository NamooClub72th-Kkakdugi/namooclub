...
<div class="container">
    ...
    <div class="error-header">
        <h2 class="error-heading">로그인 에러</h2>
    </div>
...
<script src="${ctx}/resouces/js/jquery-2.1.0.js"></script>
<script src="${ctx}/resouces/js/bootstrap.min.js"></script>
<script src="${ctx}/resouces/js/bootswatch.js"></script>
</body>
</html>