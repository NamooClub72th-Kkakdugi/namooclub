		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="well">
					...
					<form class="form-horizontal" action="${ctx}/community/comCreateCheck.do?name=${name}&id=${id}" method="post">
						<fieldset>
							...
							<div class="form-group">
								<div class="col-lg-10 col-lg-offset-2">
									...
									<button class="btn btn-default" onclick="location.href='${ctx}/community/comList.do?name=${name}'; return false;">취소</button>
								</div>
							</div>
						</fieldset>
					</form>
